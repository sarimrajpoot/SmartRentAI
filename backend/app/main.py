...
from app.api.endpoints.damage import router as damage_router
from app.api.endpoints.wishlist import router as wishlist_router
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "http://localhost:5174"] + settings.cors_origins_list,
...
app.include_router(damage_router, prefix="/api/damage", tags=["Damage"])
